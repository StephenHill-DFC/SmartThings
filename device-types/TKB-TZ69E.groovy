/**
 *  Copyright Stephen Hill (StephenHill-DFC)
 *
 *  Name: TKB TZ69E
 *
 *  Date: 08-10-2017
 ...
 *  Version: 1.0
 *
 *  Source: https://github.com/StephenHill-DFC/SmartThings/tree/master/device-types
 *
 *  Author: Stephen Hill (StephenHill-DFC)
 *  
 ...
 */
metadata {
 definition(name: "TKB-TZ69E - LED Switcher & Power Consumption", namespace: "TKB", author: "Stephen Hill", ocfDeviceType: "oic.d.switch") {
 ...
 tiles(scale: 2) {
  ...
  details(["switch", "power", "energy", "refresh", "reset", "indicator"])
 }
}
...
def zwaveEvent(physicalgraph.zwave.commands.configurationv1.ConfigurationReport cmd) {
 log "here"
 def value = "when off"
 if (cmd.configurationValue[1] == 0) {
  value = "when on"
 }
 if (cmd.configurationValue[1] == 1) {
  value = "when off"
 }
